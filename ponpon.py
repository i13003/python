...
class Paddle:
    def __init__(self, canvas, speed, color):
        self.canvas = canvas
        self.speed = speed
        self.id = canvas.create_rectangle(0, 0, 100, 10, fill=color)#ボール跳ね返すやつ
...
canvas.pack()
my_image = PhotoImage(file='/home/n15011/Downloads/aaa.gif')
canvas.create_image(0, 0, anchor=NW, image=my_image)
my_image2 = PhotoImage(file='/home/n15011/Downloads/aaa.gif')
canvas.create_image(20, 20, anchor=NW, image=my_image2)
tk.update()
...
game_over_text = canvas.create_text(350, 600, text='ponpon', state='hidden')
while True:
    ...
    if ball.hit_bottom == True:
        ...
        canvas.create_image(0, 0, image=my_image2)
        break
    tk.update_idletasks()
    tk.update()
    time.sleep(0.01)
